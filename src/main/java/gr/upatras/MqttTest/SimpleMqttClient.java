...
// subscriber or both
	...
	public static final String TOPIC = "grupatras/MqttTest/text";
...
// code to reconnect to the broker would go here if desired
	...
	public static void main(String[] args) {
		...
		smc.runClient("subscriber", false, true);
	}
	 ...
	 *
	 */
	public void runClient(String text, Boolean publisher, Boolean subscriber) {
// setup MQTT Client
...
// publish messages if publisher
		if (publisher) {
			String pubMsg = "{\"Text\":" + text + "}";
			int pubQoS = 0;
			MqttMessage message = new MqttMessage(pubMsg.getBytes());
			message.setQos(pubQoS);
			message.setRetained(false);
// Publish the message
			log.info("Publishing to topic \"" + topic + "\" qos " + pubQoS + "\" Text " + text);
